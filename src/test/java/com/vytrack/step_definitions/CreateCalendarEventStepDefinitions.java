...
public class CreateCalendarEventStepDefinitions {
    ...
    @Then("user verifies that description of new calendar event of new calendar event is\"On this meeting we discuss what went well, what went wrong and what can be improved\"And user verifies that description of new calendar event is {string}")
    public void user_verifies_that_description_of_new_calendar_event_of_new_calendar_event_is_On_this_meeting_we_discuss_what_went_well_what_went_wrong_and_what_can_be_improved_And_user_verifies_that_description_of_new_calendar_event_is(String string) {
